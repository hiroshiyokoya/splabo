...
Nintendo アカウントから [nxapi](https://github.com/samuelthomas2774/nxapi) が解析した非公式 API 経由で Splatoon 3 のバトル履歴・所持ギアを取得し、可視化・分析する OSS の PC アプリです。公式アプリのバトル履歴は直近 50 戦までですが、splabo は取得した戦績をこの PC 内のデータベースに貯めていきます。任天堂株式会社とは無関係です。
...
🌐 **ダウンロードページ**: [https://splaboon.pages.dev/](https://splaboon.pages.dev/)（[English](https://splaboon.pages.dev/en/)）
...
- **戦績** — タブ内で「ダッシュボード」と「一覧」を切り替えられます。公式アプリの履歴は直近 50 戦までですが、取ったバトルはこの PC 内のデータベースに貯まっていきます
