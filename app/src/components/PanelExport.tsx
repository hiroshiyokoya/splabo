...
/** 保存画像の右下に入るクレジット。ツール製画像の慣例に合わせた「Generated by」形式。 */
const EXPORT_CREDIT = 'Generated by SpLabo'
...
/**
 * 画像に焼き込むブランディング。右上に splabo ロゴ、右下にクレジット。
 * キャプチャ対象パネル内に置けば、`.is-exporting` 中だけ表示される。
 */
  ...
  return (
    <>
      <img
        ...
        draggable={false}
      />
      <div className="panel-export-credit" aria-hidden="true">{EXPORT_CREDIT}</div>
    </>
  )
}
